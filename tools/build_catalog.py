...
add('sets', [
 ('2024','Limited-Edition Grand Culinary Set (W.P.S. value $2,100)',1819,1637,None,None,'CWR','ch',(1819,1637,1255)),  # CPO from Carlo, Sep 2026; points estimated
...
seen = {}
for it in items:
    k = it['b'] + it.get('sfx', '') + ''.join(it.get('out', [])) + '|' + it['c']
